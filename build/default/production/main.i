...
# 1 "C:/Users/110186081/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.15.191/xc8\\pic\\include\\__null.h" 1 3
...
unsigned char Msg1[] = "Hodo Test";
unsigned char Msg2[] = "Freq=XXXXXXXX";
unsigned char Msg3[] = "Hode=XXXXXXXX";
...
# 79 "main.c"
    ...
    while (1) {
        ...
        while (PIR8bits.SMT1PRAIF == 0);
        PIR8bits.SMT1PRAIF = 0;
        Period = SMT1_GetCapturedPeriod();
        Freq = (128 * 32000.0) / (Period * 0.03125);
        Hodo = (1.0 - 32.768 / Freq) * 86400.0;

        sprintf(Msg2, "Freq=%.4f KHz", Freq);
        lcd_cmd(0x80);
        lcd_str(Msg2);
