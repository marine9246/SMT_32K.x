...
# 1 "C:/Users/user/.mchp_packs/Microchip/PIC16F1xxxx_DFP/1.15.191/xc8\\pic\\include\\__null.h" 1 3
...
char Msg1[] = "Hodo Test";
char Msg2[] = "Freq=XXXXXXXX";
char Msg3[] = "Hode=XXXXXXXX";
...
# 79 "main.c"
    ...
    while (1) {
        ...
        sprintf(Msg2, "Freq= %.4lf KHz", Freq);
        lcd_cmd(0x80);
        lcd_str(Msg2);
